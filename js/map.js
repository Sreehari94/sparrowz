$('#collapseMap').on('shown.bs.collapse', function(e){
	...
	if (!Array.prototype.forEach)
		...
		markersData = {
			...
			{
				name: 'Marathon Run',
				location_latitude: 12.958524, 
				location_longitude: 77.638310,
				map_image_url: 'img/thumb_map_1.jpg',
				name_point: 'Marathon Run',
				description_point: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard',
				url_point: 'single_tour.html'
			},
			{
				name: 'Ipanema',
				location_latitude: 30.526376, 
				location_longitude: 79.141939,
				map_image_url: 'img/thumb_map_1.jpg',
				name_point: 'Ipanema',
				description_point: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard',
				url_point: 'single_tour.html'
			...
			{
				name: 'Old Rio',
				location_latitude: 30.486293, 
				location_longitude: 79.221550,
				map_image_url: 'img/thumb_map_1.jpg',
				name_point: 'Old Rio',
				description_point: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard',
				url_point: 'single_tour.html'
